...
*  2. Check your computer ip (so the client phone will know how to access it):
*     "http://127.0.0.8:8080"
*  3. Alternatively, you can install ngrok and use it:
*       3.1 I already installed the module as a dev dependency.
*           Just open terminal in this project root and run "npm start tunnel".
...
const smatchServer = Axios.create({
    baseURL: 'http://43775563c467.ngrok.io'
});
